...
export default function FeaturedProjects() {
  return (
    <section className="py-24 max-w-7xl mx-auto px-6">
      ...
      <div className="mt-12">
        <Link href="/projects">
          <Card className="group flex flex-col sm:flex-row items-center justify-between p-8 border-primary/20 bg-primary/5 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300 shadow-sm hover:shadow-md">
